...
export class BillingAPIService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPersonUsingGET(id: string, observe?: 'body', reportProgress?: boolean): Observable<Person>;
    public getPersonUsingGET(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Person>>;
    public getPersonUsingGET(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Person>>;
    public getPersonUsingGET(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getPersonUsingGET.');
        }
        ...
        return this.httpClient.get<Person>(`${this.basePath}/billing/person/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
